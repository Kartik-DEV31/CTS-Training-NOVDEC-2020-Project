...
<body>
	...
	<div class="user">
		...
		<form class="form" action="addRestaurant" method="post">
			<div class="form__group">
				<input type="text" name="id"
					placeholder="Enter the registered Id..." class="form__input" />
			</div>

			<div class="form__group">
				<input type="text" name="restaurantName"
					placeholder="Restaurant Name..." class="form__input" />
			</div>

			<div class="form__group">
				<input type="text" name="foodServed" placeholder="foodServed..."
					class="form__input" /><br />
			</div>

			<div class="form__group">
				<input type="text" name="employeeCount"
					placeholder="employeeCount..." class="form__input" />
			</div>
